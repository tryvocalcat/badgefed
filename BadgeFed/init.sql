...
VALUES ('First Badge', 'This is the first badge', 1, '/images/first_badge.png', 'Round badge with a smiling cartoon cat over a banner than reads "Fediverse"', 'Complete the first task'),
    ('Second Badge', 'This is the second badge', 2, '/images/second_badge.png', 'Hexagonal blue and gray badge with the word "Certified" at the top and "Fediverse user" at the bottom', 'Complete the second task');
